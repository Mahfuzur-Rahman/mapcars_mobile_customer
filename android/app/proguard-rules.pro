...
#
# The rider's arrival alert ("your driver is here, PIN 1234") is exactly what
# this plugin raises, so a silent failure here is a rider standing on a kerb
# not knowing their car arrived.
