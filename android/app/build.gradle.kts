...
android {
    ...
    compileOptions {
        ...
        // flutter_local_notifications (the rider's arrival alert) uses java.time
    ...
    buildTypes {
        ...
        release {
            ...
            // GSON reflection, so R8 would break the arrival alert in release
            // builds only. See proguard-rules.pro.
            proguardFiles(
