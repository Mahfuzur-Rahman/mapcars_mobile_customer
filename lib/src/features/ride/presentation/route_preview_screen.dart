...
class _RoutePreviewScreenState extends ConsumerState<RoutePreviewScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      // Feed the real route into the ride flow so the choose-ride screen prices
      // the actual distance/duration from the fare chart.
      ref.read(rideFlowProvider.notifier).setRoute(
            pickup: Place(
