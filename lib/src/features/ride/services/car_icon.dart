...
/// Draws a top-down sedan map marker (nose pointing north): curved body with a
/// side sheen, tinted glass, roof panel, mirrors and lights.
///
...
Future<BitmapDescriptor> drawGlowingCarIcon({
  Color body = Brand.blue,
  Color glow = Brand.blue,
...
/// against a pale road.
///
/// Keep [mobile/driver_app]'s copy of this file in sync — the two apps
/// deliberately duplicate their core folders (see CLAUDE.md: no shared package).
