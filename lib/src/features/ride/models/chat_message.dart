...
/// nothing downstream has to know the rename happened - in particular the
/// chat bubble alignment, where a missed match would silently render your own
/// messages as the driver's rather than throw.
