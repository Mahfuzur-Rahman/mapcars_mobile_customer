...
/// Code-entry screen for email sign-up. The code expires after 3 minutes
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const McNavHeader(fallback: '/email-signup', showMenu: false),
              const SizedBox(height: 22),
              const McTitle('Verify your email', size: 26),
                  ...
                  children: [
                    WidgetSpan(
                      child: GestureDetector(
                        ...
                        child:
                            Text('Edit', style: tw(FontWeight.w800, 15, Brand.blue)),
                      ),
                    ),
                  ],
                ),
              ...
              Row(
                children: [
                  Ico('clock',
                      size: 16,
                      color: expired ? Colors.red : Brand.faint),
                  ...
                  GestureDetector(
                    ...
                    child: Text(
                      ...
                      style: tw(
                        FontWeight.w800,
                        14,
                        expired ? Brand.blue : Brand.faint,
                      ),
                    ),
                  ),
                ],
