...
/// without opting in — the screens that matter most here (waiting for a car,
/// mid-ride) are exactly the ones nobody would remember to annotate.
///
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Flexible(
                child: Text(
                  // Says what is still true, not just what is broken: the trip
                  // keeps running server-side while the phone is offline.
                  "No connection — your trip is still running",
                  maxLines: 1,
